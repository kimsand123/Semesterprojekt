    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answers_1', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='question_answers_1_id', to='DatabaseServiceApp.Answer')),
                ('answers_2', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='question_answers_2_id', to='DatabaseServiceApp.Answer')),
                ('answers_3', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='question_answers_3_id', to='DatabaseServiceApp.Answer')),
                ('answers_correct', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='question_answers_correct_id', to='DatabaseServiceApp.Answer')),
            ],
        ),
        migrations.CreateModel(
            name='Invite',
